...
class Yolo3DNode(Node):
    ...
    def image_callback(self, color_msg, depth_msg):
        ...
        for box in results.boxes:
            ...
            if selected is not None:
                ...
                # ====================================================
                # 핵심: 최종 노란 박스가 YOLO bbox 밖으로 나가지 않도록 clamp
                # ====================================================
                ...
                if self.is_square_class(cls_name):
                    yaw = self.normalize_square_yaw_0_45(yaw_rect)
                    yaw_mode = 'square_0_45'
                else:
                    yaw = yaw_rect
                    yaw_mode = 'normal'
    ...
    def estimate_rect_from_image_contour(self, roi_color, core_bbox, depth_mask, cls_name):
        ...
        for cnt in contours:
            ...
            # 정사각형이면 yaw 자체는 canonical로 만들고, PCA 검증을 약하게 사용
            if self.is_square_class(cls_name):
                yaw = self.normalize_square_yaw_0_45(yaw_rect)
                yaw_mode = 'square_0_45'
                pca_penalty = 0.0
    ...
    def normalize_square_yaw_0_45(self, yaw):
        yaw = float(yaw)
