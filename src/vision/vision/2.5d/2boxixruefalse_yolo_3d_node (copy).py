    ...
    def image_callback(self, color_msg, depth_msg):
        ...
        for box in results.boxes:
            ...
            if valid_pose:
                ...
                fail_text = f"{cls_name} pose failed"
                if iou_failed:
                    fail_text = f"{cls_name} IOU FAIL {final_rect_yolo_iou:.2f}"
                elif shape_failed:
                    fail_text = (
                        f"{cls_name} SHAPE FAIL "
                        f"{detected_shape}!={expected_shape} ar:{final_rect_aspect_ratio:.2f}"
                    )
                ...
                cv2.putText(
                    ...
                    self.cv_main_text_scale,
                    (0, 0, 255),
                    self.cv_main_text_thickness
                )
